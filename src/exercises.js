...
export const exercises = [
  ...
  },
  {
    ...
    verb: 'partir',
    verbEn: 'to leave',
    before: 'Ma copine était ',
    after: ' à l’étranger depuis une semaine.',
    answers: ['partie'],
    rule: 'Avec ÊTRE, accord avec le sujet « ma copine » (féminin singulier).',
    ruleEn: 'With ÊTRE, agreement with the subject « ma copine » (feminine singular).',
    formation: 'Formation : verbe en -IR → participe passé en -I (partir → parti).',
    formationEn: 'Formation: an -IR verb → past participle in -I (partir → parti).',
    examples: [
      'Ma copine est **partie** vivre au bord de la mer.',
      'Mes cousines sont **venues** passer l’été chez nous.',
    ],
    examplesEn: [
      'My friend **left** to live by the sea.',
      'My cousins **came** to spend the summer with us.',
    ],
  },
  {
    id: 34,
    ...
    verb: 'faire',
    verbEn: 'to make',
    before: 'Les glaces sont ',
    after: ' de lait, de sucre et de chocolat.',
    answers: ['faites'],
    rule: 'Avec ÊTRE, accord avec le sujet « les glaces » (féminin pluriel).',
    ruleEn: 'With ÊTRE, agreement with the subject « les glaces » (feminine plural).',
    formation: 'Formation : « faire » est une exception → participe passé « fait » (-T).',
    formationEn: 'Formation: « faire » is an exception → past participle « fait » (-T).',
    examples: [
      'Les crêpes sont **faites** avec amour par grand-mère.',
      'Le gâteau est **fait**, il sent délicieusement bon !',
    ],
    examplesEn: [
      'The crêpes are **made** with love by grandma.',
      'The cake is **made**, and it smells delicious!',
    ],
  },
  {
    id: 35,
    ...
    verb: 'manger',
    verbEn: 'to eat',
    before: 'Demain, la petite souris sera ',
    after: ' par le chat si elle n’est pas prudente.',
    answers: ['mangée'],
    rule: 'Avec ÊTRE (voix passive), accord avec le sujet « la petite souris » (féminin singulier).',
    ruleEn: 'With ÊTRE (passive voice), agreement with the subject « la petite souris » (feminine singular).',
    formation: 'Formation : verbe en -ER → participe passé en -É.',
    formationEn: 'Formation: an -ER verb → past participle in -É.',
    examples: [
      'Tous les bonbons ont disparu : ils ont été **mangés** !',
      'La pomme est **tombée** de l’arbre dans l’herbe.',
    ],
    examplesEn: [
      'All the sweets are gone: they have been **eaten**!',
  ...
  },
  {
    ...
    after: ' au jardin pour jouer.',
    answers: ['descendus'],
    rule: 'Avec ÊTRE, accord avec le sujet « les enfants » (masculin pluriel).',
    ruleEn: 'With ÊTRE, agreement with the subject « les enfants » (masculine plural).',
    formation: 'Formation : verbe en -RE → participe passé en -U (descendre → descendu).',
    formationEn: 'Formation: an -RE verb → past participle in -U (descendre → descendu).',
    examples: [
      'Les enfants sont **descendus** en courant dans le jardin.',
      'Nous sommes **restés** dehors jusqu’au coucher du soleil.',
    ],
    examplesEn: [
      'The children **went down** running into the garden.',
      'We **stayed** outside until sunset.',
    ],
  },
